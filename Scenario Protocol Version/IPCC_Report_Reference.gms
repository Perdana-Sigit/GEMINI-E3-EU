...
********************** check accounting 1118 secm and secef taht include 07



SORTIEIPCC("1118",reg,Tipcc)=SORTIEIPCC("1119",reg,Tipcc)+
                             (sum(secm,SORTIESEC("ENEP",Tipcc,Secm,reg))+sum(Secefm7,SORTIESEC("ENEP",Tipcc,Secefm7,reg))+SORTIEMAC("HENP",Tipcc,reg))*41.868/1000+
                             (sum(secm,SORTIESEC("ENEG",Tipcc,Secm,reg))+sum(Secefm7,SORTIESEC("ENEG",Tipcc,Secefm7,reg))+SORTIEMAC("HENG",Tipcc,reg)-SORTIESEC("ENEG",Tipcc,"04",reg))*41.868/1000+
                             (sum(secm,SORTIESEC("ENEC",Tipcc,Secm,reg))+sum(Secefm7,SORTIESEC("ENEC",Tipcc,Secefm7,reg))+SORTIEMAC("HENC",Tipcc,reg)-SORTIESEC("ENEC",Tipcc,"03",reg)-SORTIESEC("ENEC",Tipcc,"04",reg))*41.868/1000+
                             (sum(secm,SORTIESEC("ENEO",Tipcc,Secm,reg))+sum(Secefm7,SORTIESEC("ENEO",Tipcc,Secefm7,reg))+SORTIEMAC("HENO",Tipcc,reg)-SORTIESEC("ENEO",Tipcc,"04",reg))*41.868/1000+
                             (sum(secm,SORTIESEC("ENEB",Tipcc,secm,reg))+SORTIEMAC("HENB",Tipcc,reg))*41.868/1000;
* Primary Energy


*** Primary Energy Electricity

SORTIEIPCC("1057",reg,Tipcc)=SORTIESEC("ENEB",Tipcc,"05",reg)*41.868/1000;
SORTIEIPCC("1058",reg,Tipcc)=SORTIEELEC("SCCS","BIO",Tipcc,reg)*SORTIESEC("ENEB",Tipcc,"05",reg)*41.868/1000;
SORTIEIPCC("1059",reg,Tipcc)=(1-SORTIEELEC("SCCS","BIO",Tipcc,reg))*SORTIESEC("ENEB",Tipcc,"05",reg)*41.868/1000;
...
SORTIEIPCC("1055",reg,Tipcc)=(sum(sec,SORTIESEC("ENEB",Tipcc,sec,reg))+SORTIEMAC("HENB",Tipcc,reg))*41.868/1000;
...
SORTIEIPCC("1054",reg,Tipcc)=SORTIEIPCC("1094",reg,Tipcc)+SORTIEIPCC("1101",reg,Tipcc)+SORTIEIPCC("1113",reg,Tipcc)+SORTIEIPCC("1115",reg,Tipcc)+SORTIEIPCC("1116",reg,Tipcc)+
                             SORTIEIPCC("1070",reg,Tipcc)+SORTIEIPCC("1083",reg,Tipcc)+SORTIEIPCC("1103",reg,Tipcc)+SORTIEIPCC("1055",reg,Tipcc);
...
SORTIEIPCC("228",reg,Tipcc)=SORTIEMAC("HAGR",Tipcc,reg)+SORTIEMAC("HRIC",Tipcc,reg);
SORTIEIPCC("230",reg,Tipcc)=SORTIEMAC("HFFF",Tipcc,reg)+SORTIEMAC("HEHP",Tipcc,reg)+SORTIEMAC("HFPT",Tipcc,reg)+SORTIEMAC("HOGF",Tipcc,reg)
                           ...
                           +SORTIEMAC("HRET",Tipcc,reg);
SORTIEIPCC("240",reg,Tipcc)=SORTIEMAC("HIPP",Tipcc,reg);
SORTIEIPCC("252",reg,Tipcc)=SORTIEMAC("HWAS",Tipcc,reg);
...
SORTIEIPCC("374",reg,Tipcc)=(SORTIEMAC("NLIV",Tipcc,reg)+SORTIEMAC("NCRO",Tipcc,reg)+SORTIEMAC("NFCA",Tipcc,reg)+SORTIEMAC("NFUG",Tipcc,reg)+SORTIEMAC("NIPP",Tipcc,reg)+
                              SORTIEMAC("NWAS",Tipcc,reg)+SORTIEMAC("NOTH",Tipcc,reg));

SORTIEIPCC("376",reg,Tipcc)=SORTIEMAC("NLIV",Tipcc,reg)+SORTIEMAC("NCRO",Tipcc,reg);
SORTIEIPCC("378",reg,Tipcc)=SORTIEMAC("NFCA",Tipcc,reg)+SORTIEMAC("NFUG",Tipcc,reg);
SORTIEIPCC("385",reg,Tipcc)=SORTIEMAC("NIPP",Tipcc,reg);
SORTIEIPCC("391",reg,Tipcc)=SORTIEMAC("NOTH",Tipcc,reg);
SORTIEIPCC("392",reg,Tipcc)=SORTIEMAC("NWAS",Tipcc,reg);
...
SORTIEIPCC("451",reg,Tipcc)=(SORTIEMAC("S6MG",Tipcc,reg)+SORTIEMAC("SEPS",Tipcc,reg)+SORTIEMAC("SFPD",Tipcc,reg)+SORTIEMAC("SSEM",Tipcc,reg))*(1000/GWP_SF6);
...
SORTIEIPCC("153",regeu,Tipcc)=(1/1.120447975)*(SORTIEMAC("TAXE",Tipcc,regeu)*ABS(SORTIEMAC("GESR",Tipcc,regeu))+SORTIEMAC("ETSP",Tipcc,regeu)*ABS(SORTIEMAC("GETS",Tipcc,regeu)))/(ABS(SORTIEMAC("GESR",Tipcc,regeu))+ABS(SORTIEMAC("GETS",Tipcc,regeu)))
                               *1000*((SORTIEMAC("EXCH",Tipcc,regeu)/SORTIEMAC("EXCH",Tipcc,"USA"))*(SORTIEMAC("PGDP",Tipcc,regeu)/SORTIEMAC("PGDP",Tipcc,"USA")));
